...
class Solution:
    def getIntersectionNode(self, headA: Optional[ListNode], headB: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while pointerA and pointerB:
            if pointerA in mydict and mydict[pointerA] == 2:
                return pointerA
            if pointerB in mydict and mydict[pointerB] == 1:
                return pointerB
            mydict[pointerA] = 1
            mydict[pointerB] = 2
...
headA = array_to_linked_list([4, 1, 8, 4, 5])
headB = array_to_linked_list([5, 6, 1, 8, 4, 5])
sol = Solution()
